            ...
            <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-gradient-to-r from-white via-green-200/60 to-white mt-40">
                <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
                 ...
                 <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
                    <p className="max-w-60 text-right max-md:text-center">Create professional resumes that help you stand out and get noticed.</p>
                    <div className="flex items-center gap-4 mt-3">
                        <a href="https://github.com/Naman105" target="_blank" rel="noreferrer" aria-label="GitHub" className="hover:text-green-500 transition-colors" >
                            <FaGithub size={22} />
                        </a>
                        <a href="https://www.linkedin.com/in/namangoel08/" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="hover:text-green-500 transition-colors">
                            <FaLinkedin size={22} />
                        </a>
                        <a href="mailto:goelnaman883@gmail.com" aria-label="Email" className="hover:text-green-500 transition-colors">
                           <Mail size={22} />
                        </a>
                    </div>
                    <p className="mt-3 text-center max-md:text-center">© 2026 Resume Builder </p>
                </div>
            </footer>
